...
from nemo_skills.inference.prompt.few_shot_examples.examples_error_recovery import examples_map as examples_error_recovery

examples_map = examples_gsm8k.copy()
examples_map.update(examples_math)
examples_map.update(examples_error_recovery)
assert len(examples_map) == len(examples_gsm8k) + len(examples_math) + len(examples_error_recovery), "Duplicate keys in examples!"
